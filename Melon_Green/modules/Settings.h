 ...
 * ( Except: "Sensors" group, DiagMaxMilliSecond & century )
*/

// Sensors
	#define RTCMODULE RTC_DS1307 // Real Time Clock Module Type: RTC_DS3231, RTC_DS1307, RTC_PCF8523, RTC_PCF8563
...
// Irrigation
	...
	#define IrrigateAtDaytimeOnly  0 // [0 = OFF]
	...
	#define MaximumIrrigationPerDay  60 // minutes
// Grow Light Supplier
...
// Temperature & Humidity
	...
	#define KeepTemperatureNight 0 //[0 = OFF]
	#define TemperatureTolerance 5 //'C
	#define keepHumidityAbout 0 //[0 = OFF]
	#define keepHumidityNight 0 //[0 = OFF]
